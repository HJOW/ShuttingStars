...
웹 상에서 설치 없이 플레이할 수 있는 미니 리듬 게임입니다.
...
* https://shuttingstars.pages.dev/    
  + Cloudflare Pages 서비스 기반 서버입니다.
  + 구글 로그인, 클라우드 기록 저장 기능이 지원됩니다.
  + 버전 업데이트가 다소 늦을 수 있습니다.
  + 트래픽 사용량 제한이 널널합니다.

* https://shuttingstars-3eddf.web.app    
  + Google Firebase 기반 웹 서버입니다.
  + 구글 로그인, 클라우드 기록 저장 기능이 지원됩니다.
  + 트래픽 사용량 제한이 엄격합니다.
...
[Shutting Stars - Manager API](./docs/manager.doc.ko.md)    
